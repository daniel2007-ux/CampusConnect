        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              ...
              <p>Used by 50M+ developers</p>
            </div>
          </div>
          <h1 className='text-3xl md:text-6xl md:pd-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-700 bg-clip-text text-transparent'>More than just friends truly connect</h1>
