...
import {
  ...
  dummyPendingConnectionsData as pending_connections
} from '../assets/assets'
...
const Connections = () => {
  ...
  const data_array = [
    ...
    { label: 'Pending', value: pending_connections, icon: UserRoundPen },
    ...
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-slate-600'>Manage your followers, following, and connections.</p>
        </div>

        {/* counts */}
        <div className='mb-8 flex flex-wrap gap-6'>
          {data_array.map((items, index) => (
        ...
        <div className='flex flex-wrap gap-6 mt-6'>
          {data_array.find(item => item.label === currentTab)?.value.map((user) => (
            <div key={user._id} className='w-full max-w-md flex gap-5 p-6 bg-white shadow rounded-md'>
              ...
              <div className='flex-1'>
                ...
                <div className='flex max-sm:flex-col gap-2 mt-4'>
                  <button
                    ...
                    className='w-full p-2 text-sm rounded bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 active:scale-95 transition text-white cursor-pointer'
                  >
                    View Profile
                  </button>
